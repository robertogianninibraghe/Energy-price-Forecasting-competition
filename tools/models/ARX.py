...
class ARXRegressor:
    ...
    def __build_model__(self, loss):
        ...
        #x_in = tf.keras.layers.Reshape((self.settings['input_size'], 1))(x_in)
        x_in = tf.keras.layers.Dropout(0.1)(x_in)
        ...
        logit = tf.keras.layers.Dense(self.settings['pred_horiz'],
                                      ...
                                      kernel_regularizer=tf.keras.regularizers.l1(0.001)#needed for ensemble
                                      )(x_in)
